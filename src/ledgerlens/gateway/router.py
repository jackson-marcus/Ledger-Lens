"""Route requests to ledgerlens microservices through the registry."""
...
from ledgerlens.gateway.circuit import CircuitBreaker
from ledgerlens.gateway.middleware import GatewayMiddleware
from ledgerlens.observability.metrics import MetricsRegistry
from ledgerlens.observability.tracer import Tracer

SERVICES: tuple[str, ...] = ("extract", "validate", "policy_qa")
