...
class FakeProvider:
    ...
    test can stage a sequence of cited answers and assert how the invoice-audit
    QA flow consumes them. With no script, echoes the first prompt line so the
    retrieval-to-answer wiring stays inspectable.
    """
